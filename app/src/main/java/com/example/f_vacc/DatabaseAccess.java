...
public class DatabaseAccess  {
    private String databaseUrl = "163.44.242.11:3306";
    private String databaseName = "kvwvvvab_VCMonitoring";
    private String databaseCharSet = "latin1";
    private String databaseUser = "kvwvvvab";
    private String databasePassword = "CapstoneHosting25";
